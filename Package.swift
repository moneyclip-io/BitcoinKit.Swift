...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/moneyclip-io/BitcoinCore.Swift.git", branch: "develop"),
        .package(url: "https://github.com/horizontalsystems/HdWalletKit.Swift.git", .upToNextMajor(from: "1.0.0")),
        .package(url: "https://github.com/moneyclip-io/Hodler.Swift.git", branch: "develop"),
